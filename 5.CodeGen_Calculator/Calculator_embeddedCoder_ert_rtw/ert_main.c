...
#include "Calculator_embeddedCoder.h"  /* Model's header file */
#include "rtwtypes.h"
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  Calculator_embeddedCoder_initialize();
  ...
  /* Terminate model */
  Calculator_embeddedCoder_terminate();
