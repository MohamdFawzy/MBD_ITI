...
this.def["Stateflow_Traffic_B"] = {file: "Stateflow_Traffic_c.html",line:29,type:"var"};
this.def["Stateflow_Traffic_DW"] = {file: "Stateflow_Traffic_c.html",line:32,type:"var"};
this.def["Stateflow_Traffic_Y"] = {file: "Stateflow_Traffic_c.html",line:35,type:"var"};
this.def["Stateflow_Traffic_step"] = {file: "Stateflow_Traffic_c.html",line:38,type:"fcn"};
this.def["Stateflow_Traffic_initialize"] = {file: "Stateflow_Traffic_c.html",line:155,type:"fcn"};
this.def["Stateflow_Traffic_terminate"] = {file: "Stateflow_Traffic_c.html",line:180,type:"fcn"};
this.def["B_Stateflow_Traffic_T"] = {file: "Stateflow_Traffic_h.html",line:36,type:"type"};
this.def["DW_Stateflow_Traffic_T"] = {file: "Stateflow_Traffic_h.html",line:55,type:"type"};
this.def["ExtY_Stateflow_Traffic_T"] = {file: "Stateflow_Traffic_h.html",line:62,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["Stateflow_Traffic_c.html"] = "../Stateflow_Traffic.c";
	this.html2Root["Stateflow_Traffic_c.html"] = "Stateflow_Traffic_c.html";
	this.html2SrcPath["Stateflow_Traffic_h.html"] = "../Stateflow_Traffic.h";
	this.html2Root["Stateflow_Traffic_h.html"] = "Stateflow_Traffic_h.html";
	this.html2SrcPath["Stateflow_Traffic_private_h.html"] = "../Stateflow_Traffic_private.h";
	this.html2Root["Stateflow_Traffic_private_h.html"] = "Stateflow_Traffic_private_h.html";
	this.html2SrcPath["Stateflow_Traffic_types_h.html"] = "../Stateflow_Traffic_types.h";
	this.html2Root["Stateflow_Traffic_types_h.html"] = "Stateflow_Traffic_types_h.html";
...
var fileList = [
"ert_main_c.html","Stateflow_Traffic_c.html","Stateflow_Traffic_h.html","Stateflow_Traffic_private_h.html","Stateflow_Traffic_types_h.html","rtwtypes_h.html"];
